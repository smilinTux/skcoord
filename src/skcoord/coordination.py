...
class Board:
    ...
    def claim_task(
        ...
        Args:
            ...
            force: Compatibility override accepted by the CLI/MCP surfaces.
                Dependency eligibility is computed by ``unblocked_task_ids``;
                this flag is intentionally not used to mutate task state.
