...
_ALIAS_RULES = [
    (r"^(superseded|superseding)(_|$)",                 "superseded_by"),
    (r"^supersedes(_|$)",                               "supersedes"),
    (r"(^|_)(review_)?verdict(_|$)",                    "verdict"),
    (r"^review_(decision|disposition)(_|$)",            "review_decision"),
    ...
    (r"^replacement(_|$)|^replaces(_|$)",               "replacement"),
